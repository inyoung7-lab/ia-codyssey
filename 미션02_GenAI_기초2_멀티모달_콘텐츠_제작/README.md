...
- [EchoLens_AI_Travel_Commercial_10s.mp4](02_광고_영상/EchoLens_AI_Travel_Commercial_10s.mp4)

| 항목 | 실제 확인 결과 |
|---|---|
| 경로 | `02_광고_영상/EchoLens_AI_Travel_Commercial_10s.mp4` |
| 파일 형식 | MP4 |
| 재생 시간 | 10초 |
| 해상도 | 1920×1080 (1080p) |
| 프레임률 | 30fps |
...
기본 제작 자료 경로는 `03_제작_자료/`로 통일한다. 실제 저장소에 남아 있는 `03_제작자료/`는 중복 경로이므로 제출 문서 구조와 결과물 링크에서는 사용하지 않는다.
...
4. [최종 광고 영상](02_광고_영상/EchoLens_AI_Travel_Commercial_10s.mp4)을 재생해 10초 구성, 브랜드 엔딩, 슬로건과 CTA를 확인한다.
...
|---|---|
| Lip-sync | 미수행 |
| 동일 스토리보드 다른 도구 재제작 | 미수행 |
| 플랫폼별 화면비 버전 제작 | 미수행 |

향후 플랫폼별 버전이 필요할 경우 16:9 원본의 핵심 피사체와 텍스트 안전 영역을 기준으로 9:16은 세로 리프레이밍, 1:1은 중앙 크롭 방식으로 변환할 수 있다.
