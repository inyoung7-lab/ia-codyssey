...
- [16:9 Suno BGM 적용 버전 — EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4](02_광고_영상/EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4)
...
| 버전 | 경로 | 실제 확인 규격 |
|---|---|---|
| 16:9 Suno BGM 적용 버전 | `02_광고_영상/EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4` | MP4 파일 확인 |
| 9:16 CapCut BGM 유지 버전 | `02_광고_영상/EchoLens_AI_Travel_Commercial_9x16.mp4` | MP4, 10초, 1080×1920, 30fps |
...
| Scene 3 Pika 재제작 | [비교 실험용 보너스 결과물](01_스토리보드_기획/Bonus/scene03_pika_remake.mp4) | 최종 광고 미사용, 5초, 784×470, 30fps |
| Scene 4 | [scene04_motion.mp4](03_제작_자료/Videos/scene04_motion.mp4) | 파일 확인, Windows 메타데이터상 약 3초 |

Scene 1·5 개별 영상, 이미지 원본과 CapCut 프로젝트 파일은 현재 저장소에서 확인되지 않는다. Suno AI 생성 BGM 원본은 `03_제작_자료/Audio/echolens_ai_bgm_suno.mp3`, 해당 BGM을 적용한 16:9 최종 합본은 `02_광고_영상/EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4`에서 확인된다.
...
| 오디오 생성 | Suno AI | 16:9 최종 광고용 BGM 생성 | 프롬프트 기반으로 광고 분위기에 맞는 시네마틱 BGM을 직접 생성 가능 | 9:16 버전에는 적용하지 않음 |
| 라이브러리 BGM | CapCut BGM | 9:16 세로 버전에 `Cinematic Epic Inspiration` 유지 | 편집 타임라인에서 바로 적용하고 오디오 레벨을 조정 가능 | 오디오 생성 AI 결과가 아님 |
| 영상 편집·Export | CapCut | 생성 결과 통합, BGM 적용과 16:9·9:16 Export | 컷 편집, 전환, 색보정, 오디오 레벨 조정과 Export 가능 | 핵심 시각·오디오 생성 도구가 아님 |

16:9 최종 광고에는 Suno AI 생성 BGM `03_제작_자료/Audio/echolens_ai_bgm_suno.mp3`를 적용했다. 9:16 세로 버전은 기존 CapCut 라이브러리 BGM `Cinematic Epic Inspiration`을 사용한 상태로 유지했다. Scene별 내레이션 문구는 기획 기록이며 TTS 내레이션은 사용하지 않았다.
...
3. Suno AI용 BGM Prompt로 `echolens_ai_bgm_suno.mp3`를 생성해 16:9 최종 광고에 적용했다. 9:16 버전은 CapCut 라이브러리의 `Cinematic Epic Inspiration`을 유지했으며 TTS 내레이션은 사용하지 않았다.
...
4. [16:9 Suno BGM 적용 최종 광고](02_광고_영상/EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4)와 [9:16 CapCut BGM 유지 광고](02_광고_영상/EchoLens_AI_Travel_Commercial_9x16.mp4)를 재생해 영상 구성과 서로 다른 BGM 적용 기준을 확인한다.
...
- [Hedra Lip-sync 결과](01_스토리보드_기획/Bonus/scene03_hedra_lipsync.mp4) — Scene 3 Talking Avatar 비교 실험, 최종 광고 미사용
- [Pika 재제작 결과](01_스토리보드_기획/Bonus/scene03_pika_remake.mp4) — 동일 스토리보드 재제작 비교 실험, 최종 광고 미사용
...
16:9 최종 광고는 [Suno BGM 적용 버전](02_광고_영상/EchoLens_AI_Travel_Commercial_10s_SunoBGM.mp4)이며, Suno AI로 생성한 [BGM 원본](03_제작_자료/Audio/echolens_ai_bgm_suno.mp3)을 적용했다. 실제 순서는 Scene 3(0-3초), Scene 2(3-6초), Scene 4(6-8초), Scene 5(8-10초)이며 Scene 1은 사용하지 않았다. Scene 5는 정지 이미지 Fade로 처리했고 TTS 내레이션은 사용하지 않았다.

플랫폼별 화면비 보너스 과제로 [9:16 세로 버전](02_광고_영상/EchoLens_AI_Travel_Commercial_9x16.mp4)을 추가 제작했다. 이 파일은 기존 CapCut 라이브러리 BGM `Cinematic Epic Inspiration`을 유지한 버전으로, Suno BGM을 적용하지 않았다.
